...
public class ProductController {
	...
	public ProductController(ProductService productService, BrandService brandService, ProductMapper productMapper) {
	...
	public String editProductForm(@PathVariable("code") String code,Model model,
		...
		try {
			...
			model.addAttribute("pageTitle", "Edit existing product (CODE: "+code+")");
			
			Product product = productService.findProductByCode(code);
			ProductRequest productRequest = productMapper.modelToDTO(product);
			model.addAttribute("productRequest", productRequest);
